 ...
 * Class DayPictures
 *
 * @property \App\Models\DayPictures $model
 *
 * @see https://sleepingowladmin.ru/#/ru/model_configuration_section
 */
class DayPictures extends Section implements Initializable
{
	/**
	 * @var bool
	 */
	...
	public function onEdit($id = null, $payload = [])
	{
		$form = AdminForm::card()->addBody([
			AdminFormElement::columns()->addColumn([
				...
				AdminFormElement::select('day', 'Day', [
					'monday ' => 'Monday ',
					'tuesday' => 'Tuesday',
					'wednesday' => 'Wednesday',
					'thursday' => 'Thursday',

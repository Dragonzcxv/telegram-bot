...
class Categories extends Section implements Initializable
{
    ...
    public function onDisplay($payload = [])
    {
        $columns = [
            ...
            AdminColumn::text('action', 'Action'),
    ...
    {
        // Собираем названия методов-обработчиков
        $actions = array_filter(get_class_methods(Manager::class), function ($elem) {
            return preg_match('/.+Action/', $elem);
        });
        ...
        $form = AdminForm::card()->addBody([
            AdminFormElement::columns()->addColumn([
                ...
                AdminFormElement::select('action', 'Action')->setEnum($actions)->required(),
            ])
        ]);
